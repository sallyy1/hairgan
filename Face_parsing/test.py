...
def parsing(img, cp='79999_iter.pth'): # 사용 # 원래 : dspth='./data'
    ...
    with torch.no_grad():
        ...
        vis_parsing_maps(image, parsing, stride=1, save_im=True, save_path=osp.join('./data/label', image_path[:-4]))
            #vis_parsing_maps(image, parsing, stride=1, save_im=True, save_path=osp.join(respth,root[-3:],files[0][:-4]))

'''
# 원래 코드 백업

def parsing(respth='./data/label', dspth=None, cp='79999_iter.pth'): # 사용 # 원래 : dspth='./data'
